...
MS Excel 2007 workbooks reader, Created by Sergey Schuchkin 
http://www.sibvision.ru 
...
dimension(): fixed empty sheet dimension + sheetNames() - returns array( sheet_id => sheet_name, sheet_id2 => sheet_name2 ...)
